...
const SCHEMA_PATH =
  process.env.SCHEMA_PATH || path.join(__dirname, "../src/lib/schema.sql");
...
const carouselMapping = {
  ...
  "Sword Art Online: Alicization":
    "/carousel/SAO-gradient_-_Made_with_PosterMyWall-transformed.jpeg",
  Bakemonogatari:
    "/carousel/bakemonogatari-gradient_-_Made_with_PosterMyWall-transformed.jpeg",
  "Classroom of the Elite":
    "/carousel/classroomofelite-gradient_-_Made_with_PosterMyWall-transformed.jpeg",
  ...
  "No Longer Human":
    "/carousel/nolongerhuman-gradient_-_Made_with_PosterMyWall-transformed.jpeg",
  "The Wind-Up Bird Chronicle":
    "/carousel/thewindupbird-gradient-transformed.jpeg",
};
...
const rawBooks = [
  {
    ...
    category: "Fantasy",
    description:
      "Kirito awakens in a vast, fantastical forest filled with towering trees. In his search for clues to the nature of his surroundings, he encounters a young boy who seems to know him.",
  ...
  },
  {
    ...
    category: "Fantasy",
    description:
      "High school student Koyomi Araragi survives a vampire attack with the help of Meme Oshino, a strange man living in an abandoned building. Though no longer a vampire, Araragi retains supernatural abilities.",
  ...
  },
  {
    ...
    category: "Adventure",
    description:
      "Kiyotaka Ayanokouji has just enrolled at Tokyo Metropolitan Advanced Nurturing High School, where it's said that 100% of students go on to college or find employment.",
  ...
  },
  {
    ...
    category: "Fantasy",
    description:
      "Harry Potter's second year at Hogwarts School of Witchcraft and Wizardry is filled with new torments and horrors, including a monstrous thing that has been released into the castle.",
  ...
  },
  {
    ...
    category: "Fantasy",
    description:
      "Harry Potter is halfway through his training as a wizard and his coming of age. Harry wants to get away from the pernicious Dursleys and go to the Quidditch World Cup.",
  ...
  },
  {
    ...
    category: "Fantasy",
    description:
      "Harry Potter is due to start his fifth year at Hogwarts School of Witchcraft and Wizardry. He is desperate to get back to school and find out why his friends Ron and Hermione have been so secretive.",
  ...
  },
  {
    ...
    category: "History",
    description:
      "No Longer Human is Dazai's most famous novel, and it's also his most tragic. It tells the story of Oba Yozo, a sensitive man who feels increasingly disconnected from society.",
  ...
  },
  {
    ...
    category: "Adventure",
    description:
      "Natsuo Kirino's novel tells a story of four women who work the night shift in a Japanese lunchbox factory. One of them murders her husband, and the other three help her dispose of the body.",
  ...
  },
  {
    ...
    category: "History",
    description:
      "Toru Okada's cat has disappeared. His wife is growing increasingly distant. A mysterious woman keeps calling him on the telephone. Toru Okada's simple, quiet life is beginning to unravel.",
